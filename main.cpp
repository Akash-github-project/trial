...
void customMessageHandler(QtMsgType type, const QMessageLogContext& context,
  ...
  QString logFileName = logsDirPath + "/" +
...
int main(int argc, char* argv[]) {
  ...
  QString filePath =
      "C:\\Users\\BharatCaller\\AppData\\Local\\VidSafe\\in.vidsafe.vajiram."
      "test\\Data\\VidSafeExtracted\\8709031440\\6746cd03da8f59733bddcdbe\\6746"
      "d254da8f597723f09a21.zip";
  const QString identifier = "8709031440";
#endif

  qWarning() << "starting the app";
  MainWindow w(filePath, token, course_id, video_id, video_item_id, identifier,
               deviceId, nullptr);
  w.show();
  return a.exec();
}
